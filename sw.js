...
const CACHE = 'lernwerk-v3';
const SHELL = ['./', 'index.html', 'css/style.css', 'fragen.js', 'js/grafik.js', 'js/spiel.js', 'js/app.js', 'js/konto.js', 'js/duell.js', 'icons/icon.svg', 'manifest.webmanifest'];
