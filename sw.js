...
const CACHE = 'lernwerk-v2';
const SHELL = ['./', 'index.html', 'css/style.css', 'fragen.js', 'js/spiel.js', 'js/app.js', 'js/konto.js', 'js/duell.js', 'icons/icon.svg', 'manifest.webmanifest'];
