...
const GLYPH = {
  glocke: '<path d="M12 3a6 6 0 0 0-6 6v3.5L4.5 16h15L18 12.5V9a6 6 0 0 0-6-6z" fill="#fff"/><path d="M9.5 18.5a2.5 2.5 0 0 0 5 0" fill="#fff" opacity=".8"/>',
...
const GROESSE = {glocke:1.4, karten:1.4, gamepad:1.65, personen:1.4, pokal:1.4, buch:1.4};
